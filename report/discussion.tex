...
The prediction made by the author in \nameref{cha:method} are quite accurate missing only the fact that the number of reviews are almost zero inbetween the game release and release of the new content. 
